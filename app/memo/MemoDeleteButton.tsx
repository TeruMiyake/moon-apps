...
export interface MemoDeleteButtonProps {
  id: number;
}

export default function MemoDeleteButton({ id }: MemoDeleteButtonProps) {
  ...
  return (
    <>
      <button
        className="my-2 rounded bg-red-500 px-3 py-2 text-white"
