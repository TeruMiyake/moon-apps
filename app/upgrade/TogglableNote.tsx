...
const TogglableNote = () => {
  ...
  return (
    <div className="relative mb-4">
      ...
      {isNoteVisible && (
        <div className="absolute top-full mt-2 w-64 rounded border border-gray-300 bg-yellow-50 p-4 text-gray-800 shadow-lg">
          <h3 className="mb-2 text-lg font-bold">お願い</h3>
          <ol className="list-inside list-disc" type="1">
            <li>
              合成前から「入力する」と決めていたものだけ入力してください。
            </li>
            <li>
              成功/失敗時に偏った入力となり、統計が歪むことを防ぐためです。
            </li>
          </ol>
        </div>
      )}
